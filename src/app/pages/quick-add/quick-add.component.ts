...
export class QuickAddComponent implements OnInit {
  ...
  constructor(
    ...
    // 在 constructor 中初始化表單，確保在模板渲染前 FormControl 已就緒
    // 避免 federated context 下 mat-select writeValue(null) 錯誤
      ...
      this.transactionService.getTransactionById(this.transactionId).subscribe(transaction => {
        if (transaction) {
          ...
          this.secondFormGroup.patchValue({
            ...
            currency: transaction.currency || this.settingsService.settings().defaultCurrency,
